...
public class XmlFileItemSecondReader implements ItemReader<Vuc> {
    ...
    public XmlFileItemSecondReader(String chunkFilePath) throws JAXBException {
        this.chunkFilePath = chunkFilePath;
        this.unmarshaller = context.createUnmarshaller();
        logger.info("Second XmlFileItemReader initialized with chunk file: {}", chunkFilePath);
    }

    @Override
    public
    Vuc read() throws JAXBException {
        if (!processed) {
